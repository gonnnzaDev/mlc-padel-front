                ...
                <section className="home-container">
                    <main>
                        ...
                        <div className="presentacion">
                            ...
                            <h1>Bienvenido a MLC Padel Store!</h1>
                            <h2>Todo lo que necesitás dentro de la cancha, está acá.</h2>
                            <p>Paletas, indumentaria, accesorios y mas.</p>

                            <div className="redes-sociales-container">
                                <div className="red-social">
                                    <a href="https://www.instagram.com/mlcpadel/">
                                ...
                                <div className="red-social">
                                    <a href="https://api.whatsapp.com/send/?phone=5492236968243">
